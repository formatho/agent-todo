<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      ...
      <!-- Enhanced Activity Feed Focus -->
      <div class="mb-8">
        <div class="flex items-center justify-between mb-4">
          <h2 class="text-2xl font-bold text-gray-900">Activity Feed</h2>
          <div class="flex items-center gap-2">
            ...
            <button 
              @click="setActivityFilter('tasks')" 
              :class="['filter-btn', activityFilter === 'tasks' ? 'active' : '']"
            >
              Tasks
            </button>
            <button 
              @click="setActivityFilter('agents')" 
              :class="['filter-btn', activityFilter === 'agents' ? 'active' : '']"
            >
              Agents
            </button>
            <button 
              @click="setActivityFilter('projects')" 
              :class="['filter-btn', activityFilter === 'projects' ? 'active' : '']"
            >
              Projects
            </button>
          </div>
        ...
        <ActivityFeedEnhanced :filter="activityFilter" />
      </div>
      ...
      <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <!-- Agent Activity (smaller in this variant) -->
        <div class="xl:col-span-1">
          <AgentsDashboardCompact />
        </div>
        
        <!-- Enhanced Task Grid (larger in this variant) -->
...
import ActivityFeedEnhanced from './ActivityFeedEnhanced.vue'
import AgentsDashboardCompact from './AgentsDashboardCompact.vue'
import TaskGridEnhanced from './TaskGridEnhanced.vue'
